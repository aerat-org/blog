...
Follow the instructions for installing Pandoc Render here: [Link](https://marketplace.visualstudio.com/items?itemName=gmoe.pandoc-render)

Open the pandoc render settings, and have the .csl file point to wherever your .csl file is stored, should be in the sources
